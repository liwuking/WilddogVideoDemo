...
typedef NS_ENUM(NSInteger, WDGVideoErrorCode)
{
     ...
     *  被邀请者拒绝您的邀请
     */
    WDGVideoErrorCodeConversationRejected = 107,

    /**
     *  被邀请者繁忙，不能响应您的邀请
     */
    WDGVideoErrorCodeConversationIgnored = 108,

    /**
     *  会话无法开启
     */
    WDGVideoErrorCodeConversationFailed = 109,

    /**
     *  表明尚不支持特定功能
     *  @note: 详细信息见`localizedDescription`字段。
     */
    WDGVideoErrorCodeFeatureNotSupported = 1000,
