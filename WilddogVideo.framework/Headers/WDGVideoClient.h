...
@property(nonatomic, weak) id<WDGVideoClientDelegate> delegate;

- (instancetype)init NS_UNAVAILABLE;

- (nullable instancetype)initWithSyncReference:(WDGSyncReference *)wilddog user:(WDGUser *)user NS_DESIGNATED_INITIALIZER;
